...
/**
 * Provides the local service interface for LiferayModule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LiferayModuleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LiferayModuleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LiferayModuleLocalServiceUtil} to access the liferay module local service. Add custom service methods to <code>com.liferay.fast.develop.service.impl.LiferayModuleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LiferayModule getLiferayModule(long moduleId) throws PortalException;
