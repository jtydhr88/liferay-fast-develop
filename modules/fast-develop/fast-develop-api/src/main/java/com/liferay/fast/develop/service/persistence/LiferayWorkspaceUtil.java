...
/**
 * The persistence utility for the liferay workspace service. This utility wraps <code>com.liferay.fast.develop.service.persistence.impl.LiferayWorkspacePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LiferayWorkspacePersistence
 * @generated
 */
public class LiferayWorkspaceUtil {
	 ...
	 */
	public static void clearCache(LiferayWorkspace liferayWorkspace) {
		getPersistence().clearCache(liferayWorkspace);
	}
	 ...
	 */
	public static Map<Serializable, LiferayWorkspace> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LiferayWorkspace> findWithDynamicQuery(
	 ...
	 */
	public static LiferayWorkspace update(LiferayWorkspace liferayWorkspace) {
		return getPersistence().update(liferayWorkspace);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static LiferayWorkspace update(
		LiferayWorkspace liferayWorkspace, ServiceContext serviceContext) {

		return getPersistence().update(liferayWorkspace, serviceContext);
	}
	 ...
	 */
	public static List<LiferayWorkspace> findByUuid(String uuid) {
	 ...
	 */
	public static List<LiferayWorkspace> findByUuid(
	 ...
	 */
	public static LiferayWorkspace findByUuid_First(
			String uuid, OrderByComparator<LiferayWorkspace> orderByComparator)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {
	 ...
	 */
	public static LiferayWorkspace fetchByUuid_First(
		String uuid, OrderByComparator<LiferayWorkspace> orderByComparator) {
	 ...
	 * @throws NoSuchLiferayWorkspaceException if a matching liferay workspace could not be found
	 */
	public static LiferayWorkspace findByUuid_Last(
			String uuid, OrderByComparator<LiferayWorkspace> orderByComparator)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {
	 ...
	 */
	public static LiferayWorkspace fetchByUuid_Last(
		String uuid, OrderByComparator<LiferayWorkspace> orderByComparator) {
	 ...
	 */
	public static LiferayWorkspace[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			workspaceId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchLiferayWorkspaceException if a matching liferay workspace could not be found
	 */
	public static LiferayWorkspace findByUUID_G(String uuid, long groupId)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {
	 ...
	 */
	public static LiferayWorkspace fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching liferay workspace, or <code>null</code> if a matching liferay workspace could not be found
	 */
	public static LiferayWorkspace fetchByUUID_G(
	 ...
	 */
	public static LiferayWorkspace removeByUUID_G(String uuid, long groupId)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {
	 ...
	 * @return the matching liferay workspaces
	 */
	public static List<LiferayWorkspace> findByUuid_C(
	 ...
	 * @throws NoSuchLiferayWorkspaceException if a matching liferay workspace could not be found
	 */
	public static LiferayWorkspace findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<LiferayWorkspace> orderByComparator)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {
	 ...
	 * @return the first matching liferay workspace, or <code>null</code> if a matching liferay workspace could not be found
	 */
	public static LiferayWorkspace fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<LiferayWorkspace> orderByComparator) {
	 ...
	 * @throws NoSuchLiferayWorkspaceException if a matching liferay workspace could not be found
	 */
	public static LiferayWorkspace findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<LiferayWorkspace> orderByComparator)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {
	 ...
	 * @return the last matching liferay workspace, or <code>null</code> if a matching liferay workspace could not be found
	 */
	public static LiferayWorkspace fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<LiferayWorkspace> orderByComparator) {
	 ...
	 * @throws NoSuchLiferayWorkspaceException if a liferay workspace with the primary key could not be found
	 */
	public static LiferayWorkspace[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			workspaceId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(LiferayWorkspace liferayWorkspace) {
		getPersistence().cacheResult(liferayWorkspace);
	}
	 ...
	 */
	public static void cacheResult(List<LiferayWorkspace> liferayWorkspaces) {
		getPersistence().cacheResult(liferayWorkspaces);
	}
	 ...
	 */
	public static LiferayWorkspace create(long workspaceId) {
		return getPersistence().create(workspaceId);
	}
	 ...
	 * @throws NoSuchLiferayWorkspaceException if a liferay workspace with the primary key could not be found
	 */
	public static LiferayWorkspace remove(long workspaceId)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {

		return getPersistence().remove(workspaceId);
	}

	public static LiferayWorkspace updateImpl(
		LiferayWorkspace liferayWorkspace) {

		return getPersistence().updateImpl(liferayWorkspace);
	}
	 ...
	 * @throws NoSuchLiferayWorkspaceException if a liferay workspace with the primary key could not be found
	 */
	public static LiferayWorkspace findByPrimaryKey(long workspaceId)
		throws com.liferay.fast.develop.exception.
			NoSuchLiferayWorkspaceException {

		return getPersistence().findByPrimaryKey(workspaceId);
	}
	 ...
	 */
	public static LiferayWorkspace fetchByPrimaryKey(long workspaceId) {
		return getPersistence().fetchByPrimaryKey(workspaceId);
	}
	 ...
	 */
	public static List<LiferayWorkspace> findAll() {
	 ...
	 */
	public static List<LiferayWorkspace> findAll(int start, int end) {
	...
	public static LiferayWorkspacePersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<LiferayWorkspacePersistence, LiferayWorkspacePersistence>
			_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			LiferayWorkspacePersistence.class);

		ServiceTracker<LiferayWorkspacePersistence, LiferayWorkspacePersistence>
			serviceTracker =
				new ServiceTracker
					<LiferayWorkspacePersistence, LiferayWorkspacePersistence>(
						bundle.getBundleContext(),
						LiferayWorkspacePersistence.class, null);
